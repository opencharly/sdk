...
// node is the dispatch-merged DeployNode (never re-read from disk).
func BuildArtifactEnv(secretEnv map[string]string, node *spec.DeployNode) map[string]string {

...
// EphemeralRuntime persistence (deploykit.LoadDeployConfig is portable, but the WRITE half needs
...
// teardownChildrenRec's nested `charly deploy del` self-exec — are genuinely host-only leaves,

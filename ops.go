...
const (
	...
	// OpCompile is the K4-B deploy-COMPILE selector (command:deploy).
	...
	// OpEphemeralRegister / OpEphemeralTeardown are the command:deploy EPHEMERAL-LIFECYCLE selectors (FINAL/K5 unit 6a).
	OpEphemeralRegister = ops.OpEphemeralRegister
	OpEphemeralTeardown = ops.OpEphemeralTeardown

	// OpDeployDispatch is the command:deploy S3b selector (ELEVEN former methods through ONE wire pair, R3).

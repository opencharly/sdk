...
// picking a winner.
func AggregateCandyCapabilities(layers map[string]spec.CandyReader, order []string) (*AggregatedCandyCaps, error) {
...
func CheckRequiredCapabilities(layers map[string]spec.CandyReader, order []string, agg *AggregatedCandyCaps) []string {
	if agg == nil {

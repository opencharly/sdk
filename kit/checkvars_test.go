...
func TestResolveTestVarsRuntime_InspectFails(t *testing.T) {
	...
	meta := &spec.BoxMetadata{Box: "jupyter", User: "user", Home: "/home/user"}
...
func TestRuntimeVars_DockerBridgeIP(t *testing.T) {
	...
	r, _ := ResolveCheckVarsRuntime(&spec.BoxMetadata{Box: "foo"}, nil, "docker", "foo", "foo", "")
...
func TestResolver_EndToEndExpansion(t *testing.T) {
	...
	r, err := ResolveCheckVarsRuntime(&spec.BoxMetadata{Box: "redis", User: "u", Home: "/home/u"}, nil, "podman", "redis", "charly-redis", "")
	if err != nil {
...
func TestResolveTestVarsRuntime_DeployName(t *testing.T) {
	...
	r, err := ResolveCheckVarsRuntime(&spec.BoxMetadata{Box: "x"}, nil, "podman", "redis-ml", "charly-x", "")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	...
	r2, _ := ResolveCheckVarsRuntime(&spec.BoxMetadata{Box: "x"}, nil, "podman", "vm:k3s-vm", "charly-x", "")

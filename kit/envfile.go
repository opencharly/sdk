...
// dotenvLoaded tracks which env var names were loaded from .env (for source attribution in charly config list).
...
// Does NOT run direnv — direnv modifies the host env before charly runs.
